...
import { 
  ...
  Cpu, AlertTriangle, Users, BookOpen, BarChart4, PlayCircle
} from 'lucide-react';
...
// --- Shared Reusable UI ---
export const SectionEyebrow = ({ text, icon: Icon, color = "text-primary" }: any) => (
...
export const HeroSection = ({ navigate }: { navigate: any }) => {
